...
### Don't ignore “network reachability”
...
* Blocks are a part of Objective-C syntax, which allows to pass a function to another function as a direct argument.
...
### Coding Standards & Style Guide (syntax consistency)
...
### Code Structure within a file:
* Use marks to categorize methods in functional groupings
* In Swift, consider organizing code using internal extensions
...
* Used to specify builds that are signed for specific profiles
...
2. During continuos integration, push builds to a delivery service such as Crashlytics or TestFlight for deployment
